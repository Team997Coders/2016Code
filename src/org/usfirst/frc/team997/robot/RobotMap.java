...
public class RobotMap {
	...
	public static class Voltages {
		public static final double
		shooterPivotRobot              = 0.51, // 0.68, // Lowest shooter position
		shooterPivotGround             = 0.675, // 0.83, // Highest shooter position
		shooterPivotMiddleLow          = 0.63, // 0.77, // Low Medium shooter position
		shooterPivotMiddleHigh         = 0.57, // 0.72, // High Medium shooter position
		shooterShiftInc                = 0.01, // Increment for manual override

		collectArmPostion              = 0.675, // Where should the arm be to collect balls
		gathererArmBeforeHitRobot      = 0.25, // Highest gatherer arm position (vertical)
